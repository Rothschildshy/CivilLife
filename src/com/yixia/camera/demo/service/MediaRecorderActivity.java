...
public class MediaRecorderActivity extends BaseActivity
		implements OnErrorListener, OnClickListener, OnPreparedListener, MediaRecorderBase.OnEncodeListener {
	...
	private void initMediaRecorder() {
		...
		Log.e("", "VCamera.getVideoCachePath()  " + VCamera.getVideoCachePath());
...
//			overridePendingTransition(R.anim.push_bottom_in, R.anim.push_bottom_out);
	...
	public void onEncodeComplete() {
		...
		// bundle.putString("output", mMediaObject.getOutputTempVideoPath());
		 Log.e("", " onEncodeComplete "+mMediaObject.getOutputTempVideoPath());
		// bundle.putBoolean("Rebuild", mRebuild);
		// intent.putExtras(bundle);
		// startActivity(intent);
		 Intent intent = new Intent();
		 intent.putExtra("MediaPath", mMediaObject.getOutputTempVideoPath());
	...
	public void onVideoError(int what, int extra) {
		Intent intent = new Intent();
		 intent.putExtra("MediaPath", "转码失败");
