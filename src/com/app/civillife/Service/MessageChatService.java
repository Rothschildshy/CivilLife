...
public class MessageChatService extends Service {
	...
	public void setRequestListener(final RequestListener messagelisteners) {
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				new RequestTask(MessageChatService.this, messagelisteners, false, false, "").executeOnExecutor(
						Executors.newCachedThreadPool(), Httpurl.ChatMessageList(GlobalVariable.sendID, 1));
